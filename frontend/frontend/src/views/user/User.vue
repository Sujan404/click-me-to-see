                    ...
                    <div v-if="notifications.length > 0" class="">
                        <ul>
                            <li v-for="(notification, index) in notifications" :key="index">
                                ...
                                <br />
                                <span class="flex flex-wrap">Image URL: <a
                                        :href="this.backendServer + notification.photo_url" target="_blank">{{
                                            this.backendServer + notification.photo_url }}</a></span>
                                <br />
                                <span class="flex flex-wrap">
                                    <p class="flex flex-wrap">Image text: {{ notification.ocr_text }}</p>
                                </span>
                            </li>
                        </ul>
                    </div>
                    <h1 v-else>No notifications yet...</h1>
                    <div role="status" class="z-50 -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 bg-red-200 flex align-middle h-screen"
                        >
                        <div>
                        ...
                        <h3>Text is generating from image......</h3>
