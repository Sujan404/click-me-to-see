    ...
    <div>
        <div class="max-w-screen-xl mx-auto text-center">
            ...
            <h2 class="text-lg my-2 text-orange-600">
                ...
                I have started this website to share my learnings that I have learnt so far and will be trying my best
        ...
        <div class="max-w-screen-xl mx-auto flex flex-wrap justify-around">
            ...
            <div
                class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow bg-gray-100 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Why is docker so popular?</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Docker is used to package applications into containers. The container container all the dependencies required by an application 
                    to run.
                </p>
