<template>
    <div>
        <footer class="rounded-lg shadow text-center mt-12 bg-gray-100">
            <div
                class="max-w-screen-xl sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 antialiased mx-auto">
                <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
                    &copy; 2024 <a href="https://myale.info/" class="hover:underline" target="_blank">myale.info</a>.
                    All rights reserved.
                </p>
                <div class="flex justify-center items-center space-x-1">
                    <a href="https://www.linkedin.com/in/sujanale10404/" data-tooltip-target="tooltip-linkedin"
                    ...
                    <a href="https://github.com/Sujan404" data-tooltip-target="tooltip-github"
                        class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
                        <!-- Github -->
